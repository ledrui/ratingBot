...
// Rating Dialog ID
const RATING_DIALOG = 'ratingDialog';
...
class BasicBot {
    ...
    constructor(conversationState, userState, botConfig) {
        ...
        this.dialogs.add(new  RatingDialog(RATING_DIALOG, this.userProfileAccessor));
            ...
            if (context.activity.membersAdded.length !== 0) {
                ...
                for (var idx in context.activity.membersAdded) {
                    ...
                    if (context.activity.membersAdded[idx].id !== context.activity.recipient.id) {
                        ...
                        await context.sendActivity(`Hi! I'm the bot courtesy bot from BestFood. I'll like to  know your honest opinion about your latest visit with us`);
                    }
                }
            }
        }
